...
(function() {
    ...
    (function e(r, t) {
        ...
        function o(e, r) {
            ...
            function f(e) {
                if (typeof e === "string") e = e.split(C, 2);
                if (!w(e) || e.length !== 2) throw new Error("Invalid tags: " + e);
            ...
            while (!p.eos()) {
                ...
                if (y === "#" || y === "^") {
                    ...
                    m = t.pop();
                    if (!m) throw new Error('Unopened section "' + v + '" at ' + d);
                    if (m[1] !== v) throw new Error('Unclosed section "' + m[1] + '" at ' + d)
                } else if (y === "name" || y === "{" || y === "&") {
                    s = true
                } else if (y === "=") {
                    f(v)
            ...
            m = t.pop();
            if (m) throw new Error('Unclosed section "' + m[1] + '" at ' + p.pos);
            return j(E(n))
        }
                ...
                while (i) {
                    if (r.indexOf(".") > 0) {
                        ...
                        while (a != null && u < s.length) {
                            if (u === s.length - 1) o = l(a, s[u]) || c(a, s[u]);
                            a = a[s[u++]]
                        }
                    } else {
                        a = i.view[r];
        ...
        d.prototype.renderTokens = function e(r, t, n, i, a) {
            ...
            for (var c = 0, f = r.length; c < f; ++c) {
                ...
                u = r[c];
                o = u[0];
                if (o === "#") l = this.renderSection(u, t, n, i);
                else if (o === "^") l = this.renderInverted(u, t, n, i);
                else if (o === ">") l = this.renderPartial(u, t, n, a);
                else if (o === "&") l = this.unescapedValue(u, t);
                else if (o === "name") l = this.escapedValue(u, t);
                else if (o === "text") l = this.rawValue(u);
                if (l !== undefined) s += l
            }
            return s
        };
        ...
        d.prototype.renderInverted = function e(r, t, n, i) {
            var a = t.lookup(r[1]);
            if (!a || w(a) && a.length === 0) return this.renderTokens(r[4], t, n, i)
        };
        d.prototype.renderPartial = function e(r, t, n, i) {
            if (!n) return;
            var a = f(n) ? n(r[1]) : n[r[1]];
            if (a != null) return this.renderTokens(this.parse(a, i), t, n, a)
        };
    ...
    (function(e, r) {
        ...
        var d = {
            ...
            in: function(e, r) {
                if (!r || typeof r.indexOf === "undefined") return false;
        ...
        p.apply = function(e, r) {
            ...
            if (t === "if" || t == "?:") {
                ...
                if (n.length === i + 1) return p.apply(n[i], r);
                return null
            } else if (t === "and") {
